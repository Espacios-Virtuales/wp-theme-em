                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="<?= esc_attr($modal_id) ?>Label"><?= esc_html($post->post_title); ?></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                        </div>
                        <div class="modal-body">
                            <?= apply_filters('the_content', $post->post_content); ?>
                            <p><strong>Fecha:</strong> <?= esc_html(get_field('date', $post)); ?></p>
                        </div>
                        <div class="modal-footer">
                            ...
                            if ($producto_id) :
                            ?>
                                <a href="<?= esc_url(get_permalink($producto_id)); ?>" class="btn btn-primary">Adquirir experiencia</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
